...
```{r include=FALSE}
movie_sentiment_full <- movie_sentiment_full %>% 
  mutate(cast_bin = cut(num_cast, breaks = c(0, 10, 30, 100, Inf), labels = c("Small", "Medium", "Large", "Huge")), 
         prod_bin = cut(num_production_companies, breaks = c(0, 1, 3, 6, Inf), labels = c("Few", "Moderate", "Many", "Massive")))
```
